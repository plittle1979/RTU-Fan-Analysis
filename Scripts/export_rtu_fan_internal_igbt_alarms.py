...
suffixes = [
    ("Fan Internal Temp", "Internal"),
    ("Fan IGBT Temp", "IGBT"),
    ("Discrete Alarm 1", "Alarm 1"),
    ("Discrete Alarm 2", "Alarm 2")
]
...
for rtu in rtus:
    ...
    csv_output = f"{output_base}/{base_name}_fan_internal_igbt_alarms_raw_june_july.csv"
    excel_output = f"{output_base}/{base_name}_fan_internal_igbt_alarms_raw_june_july.xlsx"
