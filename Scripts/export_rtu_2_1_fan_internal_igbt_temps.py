...
csv_output = "C:/sqlite/RTU_Fan_Analysis/rtu_2_1_fan_internal_igbt_temps_june_july.csv"
excel_output = "C:/sqlite/RTU_Fan_Analysis/rtu_2_1_fan_internal_igbt_temps_june_july.xlsx"
...
for fan_type, fan_prefix in fan_types:
    for fan_id in fan_ids:
        for suffix, label in suffixes:
            table_name = f'RTU 2-1 {fan_type} {fan_prefix}{fan_id} {suffix}'
            try:
                query = f"""
